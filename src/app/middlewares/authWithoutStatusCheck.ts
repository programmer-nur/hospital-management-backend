...
const authWithPendingStatus = async (req: Request, res: Response, next: NextFunction) => {
    //check header
    try {
        ...
        if (['blocked', 'declined'].includes(user.status)) {
...
export default authWithPendingStatus;